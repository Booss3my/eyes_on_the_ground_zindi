...
for i in range(NUM_EPOCHS):
    ...
    print("training classification report",classification_report(labels.detach().cpu(),int(y.detach().cpu()>0.5)))
    ...
    if i%3==2: 
        ...
        print("validation classification report",classification_report(labels.detach().cpu(),int(y.detach().cpu()>0.5)))
